Version 1.3.11	
	Added button the Directory Page to tabulate students and teachers by school
	
Version 1.3.10	
	Fixed error in conditional formatting in the "Race" column of the roster table
	
Version 1.3.9	
	Removed activities from workbook entirely
	Buttons will only apply to displayed students, excluding filtered ones
	"Director" added to Staff Directory table
	Optimization in code
	Formatting fixes with dates displaying correctly
	Added "Non-Binary" gender option
	
Version 1.3.8	
	Fixed reports being names "weekly" instead of "term"
